...
//				driver.get("https://www.w3schools.com/tags/tryit.asp?filename=tryhtml_select_multiple");				
				WebDriver driver=Openbrowser.setup("chrome", "https://www.w3schools.com/tags/tryit.asp?filename=tryhtml_select_multiple");
				
				driver.switchTo().frame("iframeResult");
				//1. Identify the dropdown list and store it into WebElement
				WebElement dropdownList=driver.findElement(By.name("cars"));

				/*2. Create an instance of Select class(predefined class in Selenium) and pass dropdown list 
			   WebElement as a parameter in its constructor  */ 
				Select s1 =  new Select(dropdownList);
				System.out.println("Is it multiselect dropdownlist:"+s1.isMultiple());//true
